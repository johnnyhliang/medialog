...
// backfilled; removed together with entry_embeddings in migration 0045.
...
**Files:**
- Create: `supabase/migrations/0045_drop_entry_embeddings.sql`
...
```bash
git add supabase/migrations/0045_drop_entry_embeddings.sql src/lib/db/entries.js
...
3. Only then: run Task 5, and `npx supabase db push` to apply `0045`.
