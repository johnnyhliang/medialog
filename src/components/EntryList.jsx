...
export default function EntryList({ entries, onDelete, onStatusChange, onTagsChange, onTogglePin, onNoteSave, onPreview, onOpenRelated, onNoteVersion, onShowHistory, onTitleChange, onDueDateChange, moveTargets, onMove, tagColors, onEntryUpdate, onRetire, focusedEntryId, editTargetId, onClearEditTarget, searchQuery = '' }) {
